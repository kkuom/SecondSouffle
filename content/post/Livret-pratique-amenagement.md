---
title: "EN COURS !! Livret pratique #1 - Aménagement"
author: "Second Souffle"
date: 2016-09-01T13:15:20+02:00
readingtime: "15"
draft: false
...
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i>Macroaménagements\
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i>Moyen-aménagements\
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i>Microaménagements\
{{< image classes="fig-50 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/echelle.png?raw=true" title="" style="margin-bottom:15px" >}}
...
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><span style="color:#fa8072;;font-weight:bold">L’aménagement permanent :</span>\
...
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><span style="color:#fa8072;font-weight:bold">L’aménagement d’activité</span>, tel que celui qui sera mis en œuvre avant une activité, qui durera le temps de l’activité, et qui sera rangé ensuite.\
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><span style="color:#fa8072;font-weight:bold">L’aménagement continu</span>, tel que ceux qui se créeront pendant un stage, une colonie ou autre :\ l’affichage, le séchage, la cabane que les enfants feront, etc.\

{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo1.png?raw=true" title="" style="margin-bottom:15px" >}}

# <i class="far fa-bookmark" aria-hidden="true" style="padding-right:15px"></i>Notions de base

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Organisez la ou les régies :
...
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><b>Matériel spécifique :</b> ordinateur, projecteur, disqueuse...\
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><b>Fongibles :</b> papier, crayon, stylo, baguettes de bois, colle, etc.\
<i class="fas fa-arrow-right fa-sm" style="padding-right:7.5px;color:#fa8072"></i><b>Matériel en trop :</b> ballons, chasubles, jeux de société en plusieurs exemplaires, etc.\

{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo2.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Sachez être minimaliste :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo4.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Ayez un soucis d'esthétique :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo5.png?raw=true" title="" style="margin-bottom:15px" >}}
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo7.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Veillez à vous adapter :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo8.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Soyez pratique :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo9.png?raw=true" title="" style="margin-bottom:15px" >}}
...
## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Veillez à ce que chaque chose ait sa place :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo10.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Affichez les règles et consignes du lieu :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo11.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Apercevez-vous du chaos et gérez-le :
...
{{< image classes="fig-100 center clear fig-no-border nocaption" src="https://github.com/kkuom/SecondSouffle/blob/master/docs/images/Articles/LP1/photo12.png?raw=true" title="" style="margin-bottom:15px" >}}

## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Jetez, réparez :
...
## <i class="fas fa-lightbulb" aria-hidden="true" style="padding-right:7.5px; color:#ffc700"></i>Exemples d'organisations :
<table style="background-color: #fa8072; color:#fff">
<tr>
<td style="text-align:center"><i class="fas fa-cog fa-spin"></i><strong>&nbsp;&nbsp;Organisation par PÔLES</strong></td>
</tr>
</table>
<table>
<tr>
